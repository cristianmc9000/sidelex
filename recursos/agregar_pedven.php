...
$rVE = mysqli_query($conexion, $cVE) or die(mysql_error());
$dVE = mysqli_fetch_array($rVE);

if ($dVE['Estado'] == 1) {
$consulta = "INSERT INTO venta(Ciusu, Cicli, Fecha, Total, Codped ) SELECT b.Ci, a.Cicli, a.Fecha, a.Total, a.Codped FROM pedido a, usuario b WHERE b.Ci = ".$ciusu." AND a.Codped = ".$codped;
